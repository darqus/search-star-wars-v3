import{q as d,v as c,x as m,b8 as f,c as n,E as u,z as g,C as e,H as p,B as o,n as y,i as w,I as b}from"./index-CBOVxe6W.js";const k=`Publisher's summary There will soon come a day when the future of the
...
studied by academics of popular entertainment as late as 6 ABY.`,v={class:"swct-container"},S={class:"swct-text -js-stop"},T=d({__name:"SWCrawlText",setup(A){c(t=>({"948e0972":a.value?"hsl(60deg 100% 50% / 0.708)":"hsl(60deg 100% 30% / 0.708)"}));const r=m(),s=f(),h=k,a=n(()=>s.global.current.value.dark),l=n(()=>`color: ${a.value?"hsla(60, 100%, 50%, 0.308)":"hsla(0, 0%, 0%, 0.308)"}`);return(t,i)=>(g(),u("div",{class:w(["swct-mask",{mobile:o(r).smAndDown.value}]),style:y(l.value)},[i[0]||(i[0]=e("div",{class:"shadow"},null,-1)),e("div",v,[e("div",S,p(o(h)),1)])],6))}}),L=b(T,[["__scopeId","data-v-a285ae66"]]);export{L as default};
