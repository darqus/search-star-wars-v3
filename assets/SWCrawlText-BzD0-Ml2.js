import{d,u as c,a as m,b7 as f,j as n,h as u,o as g,e,t as p,f as o,q as y,s as w,X as b}from"./index-BJRvBrGB.js";const k=`Publisher's summary There will soon come a day when the future of the
...
studied by academics of popular entertainment as late as 6 ABY.`,v={class:"swct-container"},S={class:"swct-text -js-stop"},T=d({__name:"SWCrawlText",setup(A){c(t=>({"95b8878e":a.value?"hsl(60deg 100% 50% / 0.708)":"hsl(60deg 100% 30% / 0.708)"}));const r=m(),s=f(),h=k,a=n(()=>s.global.current.value.dark),l=n(()=>`color: ${a.value?"hsla(60, 100%, 50%, 0.308)":"hsla(0, 0%, 0%, 0.308)"}`);return(t,i)=>(g(),u("div",{class:w([{mobile:o(r).smAndDown.value},"swct-mask"]),style:y(l.value)},[i[0]||(i[0]=e("div",{class:"shadow"},null,-1)),e("div",v,[e("div",S,p(o(h)),1)])],6))}}),L=b(T,[["__scopeId","data-v-82c48aa1"]]);export{L as default};
